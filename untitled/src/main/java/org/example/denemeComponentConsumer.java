 ...
 */
public class denemeComponentConsumer extends ScheduledPollConsumer {
    private Logger LOG = LoggerFactory.getLogger(denemeComponentConsumer.class);

    private final denemeComponentEndpoint endpoint;


    public denemeComponentConsumer(final denemeComponentEndpoint endpoint, final Processor processor) {
