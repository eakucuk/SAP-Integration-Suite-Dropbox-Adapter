...
public class denemeComponentComponentTest extends CamelTestSupport {
    ...
    public void testSample() throws Exception {
        MockEndpoint mock = getMockEndpoint("mock:result");
           ...
           /* Gson gson = new Gson();
            ...
            System.out.println("Path (lower): " + metadata.pathLower);
            System.out.println("Path (display): " + metadata.pathDisplay);
